...
import org.openpnp.machine.reference.driver.AbstractTcpDriver;
...
public class AbstractTcpDriverConfigurationWizard extends AbstractConfigurationWizard {
    private final AbstractTcpDriver driver;

    public AbstractTcpDriverConfigurationWizard(AbstractTcpDriver driver) {
        this.driver = driver;
